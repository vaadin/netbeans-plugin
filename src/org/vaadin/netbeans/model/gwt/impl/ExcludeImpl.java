 ...
 * @author denis
 */
class ExcludeImpl extends FilterComponentImpl implements Exclude {

    static final String EXCLUDE = "exclude"; // NOI18N

    ExcludeImpl( GwtModelImpl model, Element e ) {
        super(model, e);
    }

    ExcludeImpl( GwtModelImpl model ) {
        this(model, createNewElement(EXCLUDE, model));
    }
