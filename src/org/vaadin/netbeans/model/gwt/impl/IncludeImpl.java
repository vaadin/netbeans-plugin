 ...
 * @author denis
 */
class IncludeImpl extends FilterComponentImpl implements Include {

    static final String INCLUDE = "include"; // NOI18N

    IncludeImpl( GwtModelImpl model, Element e ) {
        super(model, e);
    }

    IncludeImpl( GwtModelImpl model ) {
        this(model, createNewElement(INCLUDE, model));
    }
