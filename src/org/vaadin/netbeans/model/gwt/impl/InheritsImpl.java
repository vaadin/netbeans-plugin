 ...
 * @author denis
 */
class InheritsImpl extends NamedGwtComponentImpl implements Inherits {

    static final String INHERITS = "inherits"; // NOI18N

    InheritsImpl( GwtModelImpl model, Element e ) {
        super(model, e);
    }

    InheritsImpl( GwtModelImpl model ) {
        this(model, createNewElement(INHERITS, model));
    }
